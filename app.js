...
//"515ddf6e081cda91bc64ffda4c51ba54"
...
navigator.geolocation.getCurrentPosition(
    (postion) =>{
        ...
        getCurrentLocationMeather(lat, lon)
...
function getCurrentLocationMeather(lat, lon){
...
function displayWeather(data){
    ...
    weatherDescription.textContent =  descriprion
